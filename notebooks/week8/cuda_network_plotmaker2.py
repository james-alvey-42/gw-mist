...
torch.save(position_grid, 'out/position_grid')
torch.save(amplitude_grid, 'out/amplitude_grid')
torch.save(dat[0], 'out/pvalues_BCE')
torch.save(dat[1], 'out/pvalues_SNR')
