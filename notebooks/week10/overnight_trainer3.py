...
from src.simulators.fd_simulators import GW_Additive_F
from simulators.utils import *
from utils.data import OnTheFlyDataModule
from utils.module import CustomLossModule_withBounds, NewLossModule_withBounds
...
simulator = GW_Additive_F(bkg=False, fraction=0.005)
...
torch.save(network_epsilon, f'networks/network_GW_realnoise')
torch.save(model, f'networks/model_GW_realnoise')
netid = 'GW_realnoise'
